...
*/}}
{{- define "linkerd-stable-mixin.name" -}}
...
*/}}
{{- define "linkerd-stable-mixin.fullname" -}}
...
*/}}
{{- define "linkerd-stable-mixin.chart" -}}
...
Selector labels
*/}}
{{- define "linkerd-stable-mixin.selectorLabels" -}}
app.kubernetes.io/name: {{ include "linkerd-stable-mixin.name" . }}
...
app.kubernetes.io/part-of: {{ include "linkerd-stable-mixin.name" . }}
...
a8r.io/documentation: https://artifacthub.io/packages/helm/portefaix-hub/linkerd-stable-mixin
...
*/}}
{{- define "linkerd-stable-mixin.namespace" -}}
