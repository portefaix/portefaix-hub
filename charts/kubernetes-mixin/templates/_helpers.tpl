...
*/}}
{{- define "kubernetes-mixin.fullname" -}}
...
Selector labels
*/}}
{{- define "kubernetes-mixin.selectorLabels" -}}
app.kubernetes.io/name: {{ include "kubernetes-mixin.name" . }}
...
a8r.io/documentation: https://artifacthub.io/packages/helm/portefaix-hub/kubernetes-mixin
...
*/}}
{{- define "kubernetes-mixin.namespace" -}}
