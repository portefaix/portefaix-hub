...
Selector labels
*/}}
{{- define "mimir-mixin.selectorLabels" }}
app.kubernetes.io/name: {{ include "mimir-mixin.name" . }}
...
Common labels
*/}}
{{- define "mimir-mixin.labels" }}
helm.sh/chart: {{ include "mimir-mixin.chart" . }}
{{ include "mimir-mixin.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Common annotations 
*/}}
{{- define "mimir-mixin.annotations" }}
a8r.io/description: Monitoring Mixin for mimir
