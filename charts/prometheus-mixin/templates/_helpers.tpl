...
*/}}
{{- define "prometheus-mixin.fullname" -}}
...
Selector labels
*/}}
{{- define "prometheus-mixin.selectorLabels" -}}
app.kubernetes.io/name: {{ include "prometheus-mixin.name" . }}
...
Common labels
*/}}
{{- define "prometheus-mixin.labels" }}
helm.sh/chart: {{ include "prometheus-mixin.chart" . }}
{{ include "prometheus-mixin.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
*/}}
{{- define "prometheus-mixin.namespace" -}}
