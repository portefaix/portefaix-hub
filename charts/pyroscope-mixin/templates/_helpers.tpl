...
*/}}
{{- define "pyroscope-mixin.fullname" -}}
...
Common labels
*/}}
{{- define "pyroscope-mixin.labels" }}
helm.sh/chart: {{ include "pyroscope-mixin.chart" . }}
{{ include "pyroscope-mixin.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
*/}}
{{- define "pyroscope-mixin.namespace" -}}
